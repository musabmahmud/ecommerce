...
<?php
        ...
        $shopProduct = $pd->shopProduct($start_form,$per_page);
        ?>
<!-- product item start -->
    ...
    <div class="row">
        <div class="col-12">
            <ul class="pagination-box">
                <!-- Pagination -->
                <li class="<?php if($page == 1){echo 'active';}?>"><a href='shop.php?page=1'>First Page</a></li>
                <?php
                    if ($page >= 2) {
                ...
                ?>
                <li class="<?php if($page == $total_pages){echo 'active';}?>"><a href='shop.php?page=<?=$total_pages?>'>Last Page</a></span></li>
                <!-- Pagination -->
            </ul>
        </div>
    </div>
