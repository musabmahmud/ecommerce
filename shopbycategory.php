...
$shopProduct = $pd->probyCat($id, $start_form, $per_page);
?>
<!-- product item start -->
        ...
        <div class="col-12">
            <ul class="pagination-box">
                ...
                <li class="<?php if ($page == 1) {
                                echo 'active';
                            } ?>"><a href='shopbycategory.php?page=1&&catId=<?=$id?>'>First Page</a></li>
                <?php
                if ($page >= 2) {
                    echo "<li><a href='shopbycategory.php?page=" . ($page - 1) ."&&catId=".$id."'>  Prev </a></li>";
                }
                for ($i = 2; $i < $total_pages; $i++) {
                    ...
                    echo "'><a href='shopbycategory.php?page="
                    . $i ."&&catId=".$id."'>" . $i . " </a>";
                }
                if ($total_pages > $page && $page >= 2) {
                    echo "<li><a href='shopbycategory.php?page=" . ($page + 1) ."&&catId=".$id."'>  Next </a></li>";
                }
                ?>
                <li class="<?php if ($page == $total_pages) {
                                echo 'active';
                            } ?>"><a href='shopbycategory.php?page=<?= $total_pages ?>&&catId=<?=$id?>'>Last Page</a></span></li>
                <!-- Pagination -->
            </ul>
        </div>
    </div>
