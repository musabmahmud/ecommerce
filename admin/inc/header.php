...
<body>
  ...
  <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="brand.php" class="nav-link">View Brand</a></li>
        </ul><!-- sl-Category-link -->
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
            <span class="menu-item-label">Slider Image</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="slider_add.php" class="nav-link">Add Brand Image</a></li>
          <li class="nav-item"><a href="slider.php" class="nav-link">View Brand Image</a></li>
        </ul><!-- sl-Category-link -->
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
      ...
      <nav class="nav">
        <div class="dropdown">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            <span class="logged-name"><?= Session::get('username'); ?></span>
          ...
          <div class="dropdown-menu dropdown-menu-header wd-200">
            <ul class="list-unstyled user-profile-nav">
              ...
              <li><a href="logout.php?action=logout"><i class="icon ion-power"></i> Sign Out</a></li>
            </ul>
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
      </nav>
  ...
  <div class="sl-mainpanel">
    <div class="breadcrumb sl-breadcrumb">
      ...
      <span class="breadcrumb-item active"><?= ucfirst(str_replace(array(".php", "_"), array("", " "), $file_ext) . ' ');?></span>
    </div>